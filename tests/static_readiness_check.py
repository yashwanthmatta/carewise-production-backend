...
REQUIRED_STRINGS = {
    ...
    "scripts/smoke_test_deploy.py": ["/ready", "/features", "request_multipart", "/reports/upload-file", "/analyses", "/download", "/insurance/match", "/privacy/me/export", "privacy_export_analyses", "/privacy/me"],
