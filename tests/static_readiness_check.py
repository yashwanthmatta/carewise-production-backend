...
REQUIRED_FILES = [
    ...
    "scripts/backend_publish_gate.py",
...
REQUIRED_STRINGS = {
    ...
    "app/api/routes/lab_trends.py": ["create_lab_trend", "list_lab_trends", "lab_trend_saved", "LabTrendOut"],
    ...
    "scripts/backend_publish_gate.py": ["Backend Publish Readiness Gate", "smoke_test_deploy.py", "BLOCKED BEFORE REAL PATIENT DATA", "not a medical diagnosis tool"],
    ...
    "deploy/backend_publish_readiness_gate.md": ["Backend Publish Readiness Gate", "BLOCKED BEFORE REAL PATIENT DATA", "Deployed synthetic smoke test", "not a medical diagnosis tool"],
