...
REQUIRED_STRINGS = {
    ...
    "scripts/smoke_test_deploy.py": ["/ready", "/features", "request_multipart", "/reports/upload-file", "/analyses", "/download", "/insurance/match", "/privacy/me/export-summary", "privacy_summary_counts", "/privacy/me/export", "privacy_export_analyses", "privacy_export_medications", "privacy_export_intakes", "privacy_export_care_plans", "/privacy/me"],
